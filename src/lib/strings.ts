const strings = {
  creation: {
    ...
    desc: [
      ...
      "was born in a different kingdom",
  ...
  awaken: {
    ...
    Town: {
      suite: "You awaken in a tavern suite, enjoy a leisurely bath, then saunter down to the common room to break your fast.",
      room: "You awaken in a small room, listen for a moment to the sounds of the morning crowd tromping around, then get up.",
      floor: "You awaken on the tavern floor with the taste of smoke in your mouth.  You have to scramble to evade being trampled by the morning crowd, just arriving for breakfast.",
      none: "You crawl from the alley where your body has been laying all night, stretch your newly revived limbs, and go about your business."
    },
    Fields: "You awaken in a grassy meadow, soaked head to toe in morning dew.",
    Forest: "You awaken under a bush, itching horribly from insect bites. Why in the name of heaven did you decide to come to this wretched place?",
    Mounds: {
      none: "You awaken under a bench in the Gobble Inn.  You itch horribly from numerous insect bites. Why in the name of heaven did you decide to come to this wretched place?",
      cot: "You awaken on a cramped and smelly cot. Smidgen Crumb is eyeing your purse with a calculated stare.",
    },
    Mountains: "You roll over and nearly fall off a cliff before snapping to your senses in a heady rush of adrenaline.",
    Sea: "You come to consciousness on a rain swept beach.  After walking for several hours, you arrive back at the docks.",
    Dungeon: "You come to awareness in darkness with a foul stench. You crawl towards a distant light, finally emerging from a sewer into the castle.",
    stipend: "You receive {0} marks as stipend from your family's lands.",
  },
  sleep: {
    Town: {
      suite: "After a sumptuous meal, you enjoy a lazy bath, flirting with the attendant, then lay yourself down on the down filled mattresses.  You fall asleep instantly.",
      room: "You eat dinner, down a pint, wash your hands and face, then lay down on the hay filled mattress and close your eyes.",
      floor: "You bundle up your cloak and find a relatively unsoiled section of floor to sleep on.",
      none: "You drop dead in the town."
    },
    Fields: "You set camp on a grassy knoll, then watch the the sun set in radiant red and gold.",
    Forest: "You find a hollow tree, drive out the spiders and squirrels, then hole up in a cramped position.",
    Mounds: {
      none: "You sink to the bottom of degradation.  Being utterly broke and exhausted you slump into a corner of the Gobble Inn.  You have to squabble with a tame berzerker for a spot near the fire.",
      cot: "You shell out a small fortune for a small and suspiciously odiferous cot.  You down your meal of uncooked radishes, then pull the thin covers over your shivering form.",
    },
    Mountains: "You find a drafty cave that stinks of large predators.  You huddle next to a make-shift fire and descend into a nightmarish stupor.",
  ...
  shops: {
    ...
    magic: [
      ...
      "Never ask a girl's age.",
      "Queen Beth is dreeeaaamy.",
  ...
  death: "Whoops! you have been killed!!!\nThe creature steals half your gear...\nYou fall to the ground in the {0}. You will lie there unmourned until tomorrow when the spirits of the {0} will awaken you.\n\nPlease Return Tomorrow For Further Adventures!",
  encounter: {
    main: [
  ...
  noQuests: "You find yourself far too exhausted to continue adventuring. Please return tomorrow for further exploration.",
  needRope: "You cannot advance any further up these cliffs and crags without an additional supply of ROPE.",
  needLight: "You can advance no further through these dark and dingy caverns without TORCHES or some other source of light.",
  regions: {
    fields: {
      enter: [
    ...
    forest: {
      searchFail: "You start hiking towards the distant woods. You are making good time, when suddenly...",
      searchSuccess: "You trudge along the dusty trail and occasion to wonder why you haven't seen any other travellers.",
      enter: [
        "You spy an old sign that reads: 'Danger!'",
        "You find a human skull with an arrow embedded in it...",
        "You pass a pond that is obviously poisonous.",
  ...
  dinner: "You cook up a hearty dinner.",
  tent: "You prepare a tent for shelter.",
  sleepingBag: "You roll up in a sleeping bag.",
};
